...
class UDPCommandInterface(object):
	...
	def open(self, server_ip_addr, logfile_name, robot, timeout=1):
		...
		"""		
		self.local_port_extract = self.remote_ip.split(".")
		#print(self.local_port_extract) # Debug statement
		self.local_port = int(self.local_port_extract[-1]) + 5000

		#tmp1 = self.udp.connect(('8.8.8.8',53))
		#self.local_ip = str(self.udp.getsockname()[0])
